...
const PORT = process.env.PORT || 2000; // Updated to use port 5000
...
app.post('/login', async (req, res) => {
  ...
  // Discord-style error message
  const errorMessage = `
    <div style="background-color:#36393f;color:#dcddde;padding:10px;border-radius:5px;margin-bottom:10px;">
      <strong style="color:#f04747;">Login Failed:</strong> Invalid username or password.
      <ul style="list-style:none;padding:0;margin:5px 0;">
        <li><a href="/login" style="color:#00b0f0;text-decoration:none;">Try again</a></li>
        <li><a href="/register" style="color:#00b0f0;text-decoration:none;">Register</a></li>
      </ul>
    </div>
  `;
